...
|`LD_LIBRARY_PATH`|Needed in order for the binary to find the `libc++_shared.so` library (or other libraries if you compiled them into shared instead of static libraries)|`/data/data/com.myapp/files/usr/lib/arm64-v8a`|
